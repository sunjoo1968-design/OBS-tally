...
import { ChannelMatchMode, TallyObjectType, TallyType, WebTallyObjectType } from "../domain/Tally";
...
export interface ClientSentEvents {
    ...
    'tally.patch.channels': (tallyName: string, tallyType: TallyType, channelIds: string[], channelMatchMode: ChannelMatchMode) => void
